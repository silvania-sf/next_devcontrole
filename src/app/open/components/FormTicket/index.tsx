...
export function FormTicket({customer}: FormTicketProps){
    ...
    return(
        <form 
            className="bg-slate-200 mt-6 px-4 py-6 rounded border-2 border-slate-200"
            onClick={handleSubmit(handleRegisterTicket)}
        >
            ...
            <textarea
                className="w-full border-1 border-gray-400 rounded-md h-24 resize-none px-2"
